...
public class ATM {
	...
	public void cardInserted(int cardNo) {
		if(state == IDLE) {
			...
			// 当银行卡无效时，会话结束
				...
				this.monitor.setText("该卡无效，请重新插卡!");
	...
	public static void setAtmId(int atmId) {
		ATM.atmId = atmId;
	}

	public void inquiry(int balance) {
